...
namespace CustomCollection
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            LargeDataCollection largeCollection = new LargeDataCollection(initialData);

            largeCollection.DisplayCollection();
            ...
            largeCollection.Remove(3);

            largeCollection.DisplayCollection();

            largeCollection.Dispose();

            Console.WriteLine("Collection disposed.");
